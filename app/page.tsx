...
const TabButton: React.FC = ({ active, label, onClick }) => (
<button
onClick={onClick}
className={px-8 py-5 text-[11px] font-bold uppercase tracking-[0.2em] transition-all duration-300 border-b-2 whitespace-nowrap select-none active:scale-95 ${ active  ? 'border-blue-500 text-blue-400 bg-transparent shadow-[0_10px_20px_-10px_rgba(59,130,246,0.5)]'  : 'border-transparent text-slate-400 hover:text-slate-200 hover:border-slate-800' }}
